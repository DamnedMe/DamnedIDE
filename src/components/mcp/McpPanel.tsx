...
import { Plug, PlugZap, Plus, X, Trash2, Loader2, ChevronDown, ChevronUp, TerminalSquare, Bot } from 'lucide-react'
import { useMcpStore, MCP_PRESETS } from '../../store'

const PRESET_ICONS: Record<string, React.ReactNode> = {
  'claude-code': <Bot size={12} />,
  'claude-subscription': <Bot size={12} />,
